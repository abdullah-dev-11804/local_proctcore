...
final class company_config_repository {
    ...
    public function get_effective_config(int $companyid, ?int $quizid = null): \stdClass {
        ...
        $global = (object) [
            ...
            'identitymovementenabled' => (bool) $this->global_config('identitymovementenabled', 0),
            ...
            'audioanalysisenabled' => (bool) $this->global_config('audioanalysisenabled', 0),
            'audionoiseenabled' => (bool) $this->global_config('audionoiseenabled', 1),
            'audionoisethresholddbfs' => min(0.0, max(-90.0,
                (float) $this->global_config('audionoisethresholddbfs', -35.0))),
            'audionoiseminseconds' => min(120.0, max(0.5,
                (float) $this->global_config('audionoiseminseconds', 5.0))),
            'audionoisecooldownseconds' => min(3600, max(5,
                (int) $this->global_config('audionoisecooldownseconds', 60))),
            'audiospeechenabled' => (bool) $this->global_config('audiospeechenabled', 1),
            'audiovadthreshold' => min(0.99, max(0.05,
                (float) $this->global_config('audiovadthreshold', 0.65))),
            'audiospeechminseconds' => min(30.0, max(0.2,
                (float) $this->global_config('audiospeechminseconds', 0.8))),
            'audiospeechcooldownseconds' => min(3600, max(5,
                (int) $this->global_config('audiospeechcooldownseconds', 30))),
            'audiosecondspeakerenabled' => (bool) $this->global_config('audiosecondspeakerenabled', 1),
            'audiospeakersimilaritythreshold' => min(0.99, max(0.1,
                (float) $this->global_config('audiospeakersimilaritythreshold', 0.72))),
            'audiospeakerminsegments' => min(12, max(2,
                (int) $this->global_config('audiospeakerminsegments', 3))),
            'audiospeakerwindowseconds' => min(600, max(15,
                (int) $this->global_config('audiospeakerwindowseconds', 60))),
            'audiosecondspeakercooldownseconds' => min(3600, max(10,
                (int) $this->global_config('audiosecondspeakercooldownseconds', 120))),
            'audiopromptingenabled' => (bool) $this->global_config('audiopromptingenabled', 1),
            'audiopromptsustainedseconds' => min(300.0, max(2.0,
                (float) $this->global_config('audiopromptsustainedseconds', 12.0))),
            'audiopromptrollingseconds' => min(600.0, max(2.0,
                (float) $this->global_config('audiopromptrollingseconds', 20.0))),
            'audiopromptwindowseconds' => min(900, max(15,
                (int) $this->global_config('audiopromptwindowseconds', 60))),
            'audiopromptmultispeaker' => (bool) $this->global_config('audiopromptmultispeaker', 1),
            'audiopromptcooldownseconds' => min(3600, max(10,
                (int) $this->global_config('audiopromptcooldownseconds', 180))),
